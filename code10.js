...
gdjs.LowPage3Code.GDselfcheckObjects1= [];
gdjs.LowPage3Code.GDselfcheckObjects2= [];
gdjs.LowPage3Code.GDselfcheckbuttonObjects1= [];
gdjs.LowPage3Code.GDselfcheckbuttonObjects2= [];
...
gdjs.LowPage3Code.GDSFMObjects1= [];
gdjs.LowPage3Code.GDSFMObjects2= [];
...
gdjs.LowPage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11194524);
}
}}
}
...
{
{gdjs.LowPage3Code.conditionTrue_1 = gdjs.LowPage3Code.condition2IsTrue_0;
gdjs.LowPage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11196268);
}
}}
}
if (gdjs.LowPage3Code.condition2IsTrue_0.val) {
...
{
{gdjs.LowPage3Code.conditionTrue_1 = gdjs.LowPage3Code.condition2IsTrue_0;
gdjs.LowPage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11197284);
}
}}
}
if (gdjs.LowPage3Code.condition2IsTrue_0.val) {
...
{
{gdjs.LowPage3Code.conditionTrue_1 = gdjs.LowPage3Code.condition2IsTrue_0;
gdjs.LowPage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11198068);
}
}}
}
if (gdjs.LowPage3Code.condition2IsTrue_0.val) {
...
{
{gdjs.LowPage3Code.conditionTrue_1 = gdjs.LowPage3Code.condition2IsTrue_0;
gdjs.LowPage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11199588);
}
}}
}
if (gdjs.LowPage3Code.condition2IsTrue_0.val) {
...
gdjs.copyArray(runtimeScene.getObjects("SFM"), gdjs.LowPage3Code.GDSFMObjects1);

gdjs.LowPage3Code.condition0IsTrue_0.val = false;
gdjs.LowPage3Code.condition1IsTrue_0.val = false;
gdjs.LowPage3Code.condition2IsTrue_0.val = false;
{
gdjs.LowPage3Code.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.LowPage3Code.mapOfGDgdjs_46LowPage3Code_46GDSFMObjects1Objects, runtimeScene, true, false);
}if ( gdjs.LowPage3Code.condition0IsTrue_0.val ) {
{
gdjs.LowPage3Code.condition1IsTrue_0.val = gdjs.evtTools.input.isMouseButtonPressed(runtimeScene, "Left");
}if ( gdjs.LowPage3Code.condition1IsTrue_0.val ) {
{
{gdjs.LowPage3Code.conditionTrue_1 = gdjs.LowPage3Code.condition2IsTrue_0;
gdjs.LowPage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11200692);
}
}}
}
if (gdjs.LowPage3Code.condition2IsTrue_0.val) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Selfeval-Marching", false);
}}
...
gdjs.LowPage3Code.GDselfcheckObjects1.length = 0;
gdjs.LowPage3Code.GDselfcheckObjects2.length = 0;
gdjs.LowPage3Code.GDselfcheckbuttonObjects1.length = 0;
gdjs.LowPage3Code.GDselfcheckbuttonObjects2.length = 0;
...
gdjs.LowPage3Code.GDSFMObjects1.length = 0;
gdjs.LowPage3Code.GDSFMObjects2.length = 0;
